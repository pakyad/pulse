    ...
    <div className="min-h-screen bg-white flex flex-col text-slate-900 selection:bg-blue-100 md:hidden pb-32 font-sans antialiased">
      ...
      <div className="flex-1 space-y-12 py-10 px-8">
            ...
            <div className="space-y-4">
               <div className="flex items-center justify-between px-1">
                  <div className="space-y-1">
                     <h3 className="text-[15px] font-bold text-slate-900 tracking-tight">Order Registry</h3>
                ...
                {activeTab === 'ACTIVE' && (
                  pendingList.length === 0 ? (
                    <div className="py-16 px-6 bg-slate-50/50 border border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-[14px] font-bold text-slate-900 tracking-tight mb-1">You're all caught up!</h3>
                ...
                {activeTab === 'HISTORY' && (
                  historyList.length === 0 ? (
                    <div className="py-16 px-6 bg-slate-50/50 border border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-[14px] font-bold text-slate-900 tracking-tight mb-1">No past records</h3>
                        <p className="text-[11px] font-medium text-[#94a3b8] leading-relaxed max-w-[220px]">
         ...
         <section className="space-y-6">
            <div className="flex items-center justify-between px-1">
               <div className="space-y-1">
                  <h3 className="text-[15px] font-bold text-slate-900 tracking-tight">Active Inventory</h3>
                  ...
                  <div key={item.id} className="p-5 bg-slate-50/50 border border-slate-50 rounded-2xl flex items-center justify-between">
                     ...
                     <div className="flex items-center gap-2">
                        <button
                           onClick={() => setEditingItem(item)}
                           title="Edit"
                           className="w-9 h-9 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400 hover:text-slate-900 transition-all"
                        >
                           <Pencil size={14} />
                        </button>
                        <button
