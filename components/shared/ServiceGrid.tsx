...
const services = [
  ...
  { id: 7, label: 'Student Market', icon: () => <ShoppingBag size={22} className="text-[#3B6D11] drop-shadow-sm" strokeWidth={2.5} />, path: '/marketplace?filter=student', color: 'bg-[#EAF3DE]', shadow: 'bg-[#B0CF90]' },
];
