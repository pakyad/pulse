    ...
    return (
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="p-10 bg-slate-50/50 rounded-2xl border border-slate-100 text-center space-y-4">
        ...
        <div className="space-y-1">
           <h4 className="text-[15px] font-bold text-[#1e293b]">Thank You</h4>
  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="px-2 space-y-1">
        <h3 className="text-[17px] font-bold text-[#1e293b] tracking-tight">Feedback</h3>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-6 space-y-4">
        ...
        <div className="space-y-4">
           <h4 className="text-[14px] font-bold text-[#1e293b] truncate">{order.title || 'Item Review'}</h4>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-6 space-y-4">
        ...
        <div className="space-y-4">
           <h4 className="text-[14px] font-bold text-[#1e293b]">Delivery Runner</h4>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-6 space-y-4">
        ...
        <textarea 
          ...
          className="w-full h-24 text-[13px] font-medium text-[#1e293b] focus:outline-none placeholder:text-slate-200 resize-none leading-relaxed"
          value={comment}
      ...
      <button 
        ...
        className="w-full h-14 bg-[#1e293b] text-white rounded-xl font-bold text-[12px] uppercase tracking-[0.2em] shadow-lg shadow-slate-900/5 disabled:opacity-20 transition-all flex items-center justify-center gap-3 active:scale-95"
      >
