...
export default function GenesisSetup() {
  ...
  return (
    <div className="h-screen w-full bg-slate-900 flex flex-col items-center justify-center font-sans p-6 text-center">
      ...
      {status === 'idle' && (
        <button 
          onClick={createAdmin}
          className="bg-[#007AFF] text-white font-bold px-10 py-4 rounded-2xl hover:bg-slate-900 transition-all active:scale-95 shadow-md shadow-slate-900/10"
        >
