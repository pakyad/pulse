            ...
            <div className="flex items-center gap-6">
               <div className="relative">
                  ...
                  {profile?.is_verified_merchant || profile?.role === 'CLUB' ? (
                    <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-white rounded-xl border border-slate-100 flex items-center justify-center text-slate-900 shadow-md">
            ...
            {/*  PROFILE ACTIONS  */}
             <div className="flex gap-3">
                ...
                <button 
                   ...
                   className="w-12 h-12 bg-white border border-slate-200 text-slate-400 rounded-2xl flex items-center justify-center hover:bg-red-50 hover:text-red-500 hover:border-red-100 active:scale-95 transition-all shadow-sm"
                >
                   <ShieldAlert size={18} />
                </button>
             </div>
               ...
               <div className="grid grid-cols-2 gap-x-4 gap-y-8">
                  {myListings.map((item) => (
                     <button 
                        ...
                        className="group flex flex-col text-left active:scale-95 transition-all"
                     >
