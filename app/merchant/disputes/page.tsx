                     ...
                     >
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                           ...
                           <div className="flex items-center gap-1.5">
                              <div className={`w-1 h-1 rounded-full ${dispute.status === 'MERCHANT_RESPONDED' ? 'bg-blue-500' : 'bg-red-500 animate-pulse'}`} />
                              <span className={`text-[9px] font-black uppercase tracking-widest ${dispute.status === 'MERCHANT_RESPONDED' ? 'text-blue-500' : 'text-red-500'}`}>
